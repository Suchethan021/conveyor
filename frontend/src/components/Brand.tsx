// Wordmark + logo. The arrow suggests a pipeline moving work forward.
export function Brand({ className = '' }: { className?: string }) {
  return (
    <span className={`flex items-center gap-2 ${className}`}>
      ...
      <span className="text-lg font-semibold tracking-tight text-slate-900">Conveyor</span>
    </span>
  )
}

// The GitHub mark, for the login button.
